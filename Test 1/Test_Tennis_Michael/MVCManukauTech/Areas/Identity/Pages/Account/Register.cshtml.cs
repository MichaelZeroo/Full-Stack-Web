...
namespace MVCManukauTech.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new MVCManukauTechUser { UserName = Input.Email,
                    Email = Input.Email,
                    IsCompeting = Input.IsCompeting,
                    NumberOfPenalties = Input.NumberOfPenalties,
                    ComitteePosition = Input.ComitteePosition,
                    BiggestPrizeAmount = Input.BiggestPrizeAmount
                };
