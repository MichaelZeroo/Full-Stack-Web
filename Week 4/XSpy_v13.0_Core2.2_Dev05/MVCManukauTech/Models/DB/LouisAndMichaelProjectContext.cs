...
{
    public partial class LouisAndMichaelProjectContext : DbContext
    {
        public LouisAndMichaelProjectContext()
        {
        }

        public LouisAndMichaelProjectContext(DbContextOptions<LouisAndMichaelProjectContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=citizen.manukautech.info,6303;Database=LouisAndMichaelProject;UID=F191_Louis;PWD=fBit$47490;Encrypt=true;TrustServerCertificate=true;;MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.ImgColumn).HasColumnType("image");
